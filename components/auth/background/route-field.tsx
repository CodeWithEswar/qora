...
export function RouteField({ className }: RouteFieldProps) {
  return (
    ...
    >
      <defs>
        {/* Subtle glowing signal gradient */}
        <linearGradient id="signalGradA" x1="0%" y1="0%" x2="100%" y2="0%">
        ...
        <linearGradient id="signalGradB" x1="0%" y1="0%" x2="0%" y2="100%">
      ...
      <g className="opacity-60 dark:opacity-80">
        ...
        {/* Animated Travelling Signal Pulse */}
        <path
          d="M 60 180 L 240 180 L 240 300 L 180 300"
          fill="none"
          stroke="url(#signalGradA)"
          strokeWidth="1.5"
