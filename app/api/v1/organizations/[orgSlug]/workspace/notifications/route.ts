...
/**
 * PATCH /api/v1/organizations/:orgSlug/workspace/notifications
 * Updates workspace notification channel toggles and event policies.
 */
export async function PATCH(request: NextRequest, { params }: Params) {
  ...
  try {
    ...
    const updated = await SupabaseWorkspaceRepository.updateNotificationPreferences(
      org.id,
      body,
