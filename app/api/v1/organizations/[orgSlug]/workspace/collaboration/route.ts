...
/**
 * PATCH /api/v1/organizations/:orgSlug/workspace/collaboration
 * Updates default member role, invitation rules, and sharing policies.
 */
export async function PATCH(request: NextRequest, { params }: Params) {
  ...
  try {
    ...
    const updated = await SupabaseWorkspaceRepository.updateCollaborationPolicy(
      org.id,
      body,
