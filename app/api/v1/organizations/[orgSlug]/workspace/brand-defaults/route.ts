...
/**
 * PATCH /api/v1/organizations/:orgSlug/workspace/brand-defaults
 * Sets or unsets the workspace-level default Brand Kit.
 */
export async function PATCH(request: NextRequest, { params }: Params) {
  ...
  try {
    ...
    const updated = await SupabaseWorkspaceRepository.updateBrandDefaults(
      org.id,
      body.defaultBrandKitId || null,
