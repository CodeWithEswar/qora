...
/**
 * PATCH /api/v1/organizations/:orgSlug/workspace/qr-defaults
 * Updates workspace-level default QR design, error correction, and quiet zone settings.
 */
export async function PATCH(request: NextRequest, { params }: Params) {
  ...
  try {
    ...
    const updated = await SupabaseWorkspaceRepository.updateQrDefaults(
      org.id,
      body,
