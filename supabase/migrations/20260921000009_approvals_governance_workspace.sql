-- Migration: 20260921000009_approvals_governance_workspace.sql
-- Upgrades approval_requests for immutable revision governance, status extension, and change topology

-- 1. Upgrade status check constraint to support full governance lifecycle
...
-- 2. Add explicit immutable revision tracking and governance topology columns
...
-- 3. Indexes for fast revision lookups and queue sorting
