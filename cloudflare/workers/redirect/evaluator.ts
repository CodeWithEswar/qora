 ...
 *  - Device class (mobile, desktop, tablet, other)
 *  - Operating system (ios, android, windows, macos, linux, other)
 *  - Browser family (safari, chrome, firefox, edge, samsung_internet, other)
 *  - Primary language & locale
 *  - Edge-derived coarse geography (Country, Region)
 *  - Timezone-aware local time and weekday
 *  - Untrusted query parameter extraction (bounded & sanitized)
 * 
 * Delegates rule and condition evaluation 1:1 to @nxtqr/contracts.
 */
